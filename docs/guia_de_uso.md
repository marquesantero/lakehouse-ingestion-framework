...
pip install build
python -m build
# gera: dist/contractforge-2.6.1-py3-none-any.whl
```
...
2. Source: **Volume**
3. File path: `/Volumes/<catalog>/<schema>/libs/contractforge-2.6.1-py3-none-any.whl`
4. Install
...
print(contractforge.__version__)  # 2.6.1
...
```python
%pip install --index-url https://<seu_pypi_privado> contractforge==2.6.1
```
